                ...
                <ul className="dropdown-menu mega-menu">
                  <li className="yamm-content">
                    <div className="row">
                      ...
                      <div className="dropdown-banner-holder"> <a href="#"><img alt='loading' src="/src/assets/images/banners/banner-side.png" /></a> </div>
                    </div>
                    {/* /.row */} 
                  </li>
                  {/* /.yamm-content */}
                    ...
                    <div className="products">
                      <div className="product">
                        <div className="product-image">
                          <div className="image"> 
                            <a href="detail.html">
                              <img src="/src/assets/images/products/p4.jpg" alt="loading" /> 
                              <img src="/src/assets/images/products/p4_hover.jpg" alt="loading" className="hover-image" />
                            </a>
                          </div>
                          {/* /.image */}
                        </div>
                    ...
                    <div className="products">
                      <div className="product">
                        <div className="product-image">
                          <div className="image"> 
                            <a href="detail.html">
                              <img src="/src/assets/images/products/p6.jpg" alt="loading" /> 
                              <img src="/src/assets/images/products/p6_hover.jpg" alt="loading" className="hover-image" />
                            </a> 
                          </div>
                          {/* /.image */}
                    ...
                    <div className="products">
                      <div className="product">
                        <div className="product-image">
                          <div className="image"> 
                            <a href="detail.html">
                              <img src="/src/assets/images/products/p5.jpg" alt="loading" /> 
                              <img src="/src/assets/images/products/p5_hover.jpg" alt="loading" className="hover-image" />
                            </a>
                          </div>
                          {/* /.image */}
                          <div className="tag new"><span>new</span></div>
                    ...
                    <div className="products">
                      <div className="product">
                        <div className="product-image">
                          <div className="image"> 
                            <a href="detail.html">
                              <img src="/src/assets/images/products/p12.jpg" alt="loading" /> 
                              <img src="/src/assets/images/products/p12_hover.jpg" alt="loading" className="hover-image" />
                            </a>
                          </div>
                          {/* /.image */}
                          <div className="tag hot"><span>hot</span></div>
                  ...
                  <div className="item item-carousel">
                    <div className="products">
                      <div className="product">
                        <div className="image"> 
                          <a href="detail.html">
                            <img src="/src/assets/images/products/p14.jpg" alt="loading" /> 
                            <img src="/src/assets/images/products/p14_hover.jpg" alt="loading" className="hover-image" />
                          </a>
                        </div>
                        {/* /.product-image */}
                        <div className="product-info text-left">
