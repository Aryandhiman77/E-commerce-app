...
const ProductVarient = (props) => {
    ...
    // console.log(params.category,params.varient)  
    const addItem = (e)=>{
        let varientid = e.target.value;
    addToCart({ varientid, quantity: 1 });
    }
                ...
                <div className="row">
                  ...
                  <div className="col-sm-12 col-md-8 col-lg-8 product-info-block">
                    <div className="product-info">
                      <h1 className="name">{viewProduct.product_name+"-"+viewVarient.varient_name}</h1>
                        ...
                        <div className="row">
                          ...
                          <div className="add-btn">
                            <button
                              href="#"
                              className="btn btn-primary"
                              value={viewVarient._id?viewVarient._id:viewProduct._id}
                              onClick={addItem}
                            >
