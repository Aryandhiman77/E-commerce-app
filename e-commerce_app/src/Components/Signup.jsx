  ...
  return (
    <div>
       <div className='container border mt-5 p-4 px-3 rounded px-4 border-0 text-light' style={{width:'30rem',backdropFilter:' blur(10px)',boxShadow: '0px 0px 10px 0px black'}}>
            ...
            <h2>Register</h2>
                <Link to={'/login'} className="btn btn-sm btn-outline-danger mx-1 rounded-2 text-light mb-3" style={{backgroundImage: 'linear-gradient(387deg, #f04060, #fe523a, #ff6500)'}}>Login</Link>
                </div>
            <form> 
                <div className="mb-3">
                ...
                <button type="submit" className="w-100 btn mx-1 rounded-2 text-light" style={{backgroundImage: 'linear-gradient(387deg, #f04060, #fe523a, #ff6500)'}}>Register</button>
                </div>
